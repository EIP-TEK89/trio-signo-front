      ...
      <div className="hero-wrapper">
        ...
        <div className="hero-container">
          <div className="hero-content">
            <div>
              <span className="hero-badge">Découvrez la Langue des Signes Française</span>
            </div>

            <h1 className="hero-title">
              Apprenez à signer{' '}
              <span className="hero-title-highlight">
                <span className={`changing-phrase ${animationState || ''}`}>{words[currentWordIndex]}</span>
              </span>
            </h1>

            <p className="hero-description">
              Rejoignez une communauté vivante et découvrez la richesse de la langue des signes française à travers des
              leçons interactives, des vidéos claires et un apprentissage personnalisé.
            </p>

            <div className="hero-buttons">
              <button className="hero-btn-primary" onClick={Login}>
                Commencer
                <svg
              ...
              <a className='hero-btn-secondary' href={"/shared/app-release.apk"} download>Installer l'application</a>
            </div>
          </div>
