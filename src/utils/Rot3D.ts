export function rot_3d_x(coord: [number, number, number], angle: number): [number, number, number] {
    const [x, y, z] = coord;
...
export function rot_3d_y(coord: [number, number, number], angle: number): [number, number, number] {
    const [x, y, z] = coord;
...
export function rot_3d_z(coord: [number, number, number], angle: number): [number, number, number] {
    const [x, y, z] = coord;
